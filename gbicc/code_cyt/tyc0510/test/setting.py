...
# SERVICE = "tycprd"
# ORALCE_DATABASE = "tyc"
# ORALCE_USER = "tyc_standard"
# ORALCE_PASSWORD = "TycS_%2019"
#################################################################
# 本地
...
#########################泰兴环境#########################
#
# ORALCE_HOST = "192.168.1.171:1521"
# SERVICE = "dbsrv2"
# ORALCE_DATABASE = "tyc"
# ORALCE_USER = "comm"
# ORALCE_PASSWORD = "123456"
...
tyc_page = {
    ...
    # 行政许可
    "_container_licensing": ["https://www.tianyancha.com/pagination/licensing.xhtml?ps=10", "id", 10],
    #
    # 股东信息
    ...
    "_container_baipin": ["https://www.tianyancha.com/pagination/baipin.xhtml?ps=10", "id", 10],
    ...
    # 产品信息 ++
    "_container_product": ["https://www.tianyancha.com/pagination/product.xhtml?ps=10", "id", 10],
    # 资质证书 ++
    ...
    # 网站备案 ++
    "_container_icp": ["https://www.tianyancha.com/pagination/icp.xhtml?ps=10", "id", 10],
    # 信用中国
    ...
    # 网站备案 ++
    "nav-main-icpCount": ["https://www.tianyancha.com/pagination/icp.xhtml?ps=5", "id", 10],
