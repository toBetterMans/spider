...
=======
>>>>>>> 1b687211f080a9702702c2be72212908e086aecd
        ...
        if table:
            ...
            if trs:
                ...
                for div in trs:
                    ...
                    unique_field = [
                        'company_name',
                        mainPerson.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_investInfo(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                unique_field = ['company_name',
                                investInfo.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_alterRecord(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                # TODO: 变更记录无唯一字段
                unique_field = ['company_name',
                                alterRecord.company_name]  # 该模块中唯一值字段名和值
        ...
        if year_selector:
            ...
            if trs:
                ...
                for tr in trs:
                    ...
                    unique_field = [
                        'company_name',
                        website.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_year_gdczxx(self, year_selector, year):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                unique_field = [
                    'company_name',
                    gdcz.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_branch(self, index):
        ...
        if root_div:
            ...
            for tr in trs:
                ...
                unique_field = [
                    'company_name',
                    flss.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_ktgg(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                unique_field = [
                    'company_name',
                    ktggInfo.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_sfxz(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                unique_field = [
                    'company_name',
                    sfxzInfo.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_illegalSerious(self):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                # TODO:
                unique_field = ['company_name',
                                illegalSerious.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_taxesNotice(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                # TODO:
                unique_field = ['company_name',
                                taxesNotice.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_sfpm(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                unique_field = [
                    'company_name',
                    sfpaInfo.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_gscg(self):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                unique_field = [
                    'company_name',
                    gscgInfo.company_name]  # 该模块中唯一值字段名和值
    ...
    def html_parse_financeHistory(self):
        ...
        if trs:
            ...
            for tr in trs:
                insert_value = ""
                tds = tr.xpath('./td')
                flss.financeDate = try_and_text(
                    "variable[1].xpath('string(.)')", tds)
                flss.event_date = try_and_text(
                    "variable[2].xpath('string(.)')", tds)
                flss.financeRound = try_and_text(
                    "variable[4].xpath('string(.)')", tds)
                flss.financeValue = try_and_text(
                    "variable[5].xpath('string(.)')", tds)
                flss.financeMoney = try_and_text(
                    "variable[3].xpath('string(.)')", tds)
                flss.financeRatio = try_and_text(
                    "variable[6].xpath('string(.)')", tds)
                flss.financeInvestor = try_and_text(
    ...
    def html_parse_entBusiness(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                tds = tr.xpath('./td')
                insert_value = ""
                flss.businessName = try_and_text(
                    "variable[1].xpath('.//td//text()')[-1]", tds)
                flss.businessQuale = try_and_text(
                    "variable[2].xpath('.//text()')[-1]", tds)
                flss.businessInfo = try_and_text(
                    "variable[3].xpath('./div/div//text()')[0]", tds)
                flss.txt_id = self.txt_id
                flss.company_name = key
                flss.mark = 0
    ...
    def html_parse_investEvent(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                insert_value = ""
                tds = tr.xpath('./td')
                flss.touziDate = try_and_text(
                    "variable[1].xpath('string(.)')", tds)
                flss.touziRound = try_and_text(
                    "variable[2].xpath('string(.)')", tds)
                flss.touziMoney = try_and_text(
                    "variable[3].xpath('string(.)')", tds)
                flss.touziEnt = try_and_text(
                    "variable[4].xpath('string(.)')", tds)
                flss.touziProduct = try_and_text(
                    "(variable[5].xpath('.//a/text()'))[0]", tds)
                flss.touziArea = try_and_text(
                    "variable[6].xpath('string(.)')", tds)
                flss.touziIndustry = try_and_text(
                    "variable[7].xpath('string(.)')", tds)
                flss.touziBusiness = try_and_text(
    ...
    def html_parse_jpInfo(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                insert_value = ""
                tds = tr.xpath('./td')
                flss.jpProduct = try_and_text(
                    "variable[1].xpath('.//a/text()')[0]", tds)
                flss.jpArea = try_and_text(
                    "variable[2].xpath('.//text()')[0]", tds)
                flss.jpRound = try_and_text(
                    "variable[3].xpath('.//text()')[0]", tds)
                flss.jpIndustry = try_and_text(
                    "variable[4].xpath('.//text()')[0]", tds)
                flss.jpBusiness = try_and_text(
                    "variable[5].xpath('.//text()')[0]", tds)
                flss.jpDate = try_and_text(
                    "variable[6].xpath('.//text()')[0]", tds)
                flss.jpValue = try_and_text(
        ...
        if index == 1 and not isinstance(self.selector, int):
            ...
            if trs:
                ...
                for tr in trs:
                    ...
                    tds = tr.xpath('./td')
                    # 许可书文编号
                    flss.licenseDocNum = try_and_text(
                        "variable[1].xpath('./text()')[0]", tds)
                    # 许可文件名称
                    flss.licenseDocName = try_and_text(
                        "variable[2].xpath('./text()')[0]", tds)
                    # 有效期自
                    flss.validityBegin = try_and_text(
                        "variable[3].xpath('./text()')[0]", tds)
                    # 有效期至
                    flss.validityEnd = try_and_text(
                        "variable[4].xpath('./text()')[0]", tds)
                    # 许可机关
                    flss.licenseAuthority = try_and_text(
                        "variable[5].xpath('./text()')[0]", tds)
                    # 许可内容
                    flss.licenseContent = try_and_text(
                        "variable[6].xpath('./text()')[0]", tds)
    ...
    def html_parse_certificateInfo(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                insert_value = ""
                tds = tr.xpath('./td')
                flss.certificateType = try_and_text(
                    "variable[1].xpath('./span/text()')[0]", tds)
                flss.certificateNum = try_and_text(
                    "variable[2].xpath('./span/text()')[0]", tds)
                flss.sendDate = try_and_text(
                    "variable[3].xpath('./span/text()')[0]", tds)
                flss.offDate = try_and_text(
    ...
    def html_parse_dxxk(self, index):
        ...
        if trs:
            ...
            for tr in trs:
                ...
                tds = tr.xpath('./td')
                # 许可证号
                flss.licenseKey = try_and_text(
                    "variable[1].xpath('./text()')[0]", tds)
                # 业务范围
                flss.businessSphere = try_and_text(
                    "variable[2].xpath('./text()')[0]", tds)
                # 是否有效
            ...
            if NEXT_PAGE_DICT[search_name]:
                ...
                ll = {
                    '北京百度网讯科技有限公司': {
                        ...
                        'tyc_zscq_zzq': '软件著作权',
                        'tyc_zscq_zpzzq': '作品著作权'}}
                not_parse_table_names = str(list(NEXT_PAGE_DICT[search_name].keys()))[
                    1:-1]  # 得出未解析的模块名称拼接字符串
                next_page_parse = CheckResult()
                next_page_parse.company_name = search_name
                next_page_parse.add_time = func.now()
                next_page_parse.different_reason = '分页未解析模块:' + \
                    str(list(NEXT_PAGE_DICT[search_name].values()))[1:-1]
                ...
                try:
                    print(
                        'next_page_parse=================',
                        next_page_parse.__dict__)
                    single_oracle_orm.add(next_page_parse)
                    single_oracle_orm.commit()
                except Exception as e:
                    print(
                        '分页未解析模块提交异常：{}'.format(e),
                        next_page_parse.different_reason)
